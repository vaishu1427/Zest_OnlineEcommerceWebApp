...
import { createAddress, changeAddress, getAddress, deleteAddress, getAddressById } from "../api/addressService";
...
export const fetchAddressById =
    createAsyncThunk('address/fetchAddressById', async (body) => {
...
export const addressSlice = createSlice({
    ...
    extraReducers: {
        ...
        [fetchAddressById.rejected]: (state) => {
            state.fetchAddressInProcess = false
            console.log("Address fetch failed")
        },
    }
