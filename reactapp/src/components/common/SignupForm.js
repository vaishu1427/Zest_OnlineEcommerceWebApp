...
export default function SignupForm(props) {
    ...
    const [inputValue, setInputValue] = useState({ firstName: '', lastName: '', email: '', phone: '', password: '', roles: 'BUYER', gender: 'Male' });
                    ...
                    if (emailValidation.test(inputValue.email)) {
                        if (passwordValidation.test(inputValue.password)) {
                            if (phonenoValidation.test(inputValue.phone)) {
                                ...
                                setInputValue({ firstName: '', lastName: '', email: '', address: '', phone: '', password: '', roles: 'BUYER', gender: 'Male' })
                            }
                            else {
                    ...
                    <div class="container">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline text-start">
                                <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault4" checked={inputValue.gender === "Male"} onChange={() => { setInputValue({ ...inputValue, gender: "Male" }) }} />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline text-start">
                                <input class="form-check-input" type="radio" name="role" id="flexRadioDefault2" checked={inputValue.roles === "ROLE_BUYER"} onChange={() => { setInputValue({ ...inputValue, roles: "ROLE_BUYER" }) }} />
